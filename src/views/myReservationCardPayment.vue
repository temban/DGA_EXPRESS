        ...
        <b-col lg="6" class="mb-2 mb-lg-0">
          <div class="card" style="border-radius: 15px; height: 60%">
            <div class="card-body text-center">
              ...
              <h4 style="color: black; text-transform: capitalize" class="mb-2">
                {{ this.names }}
              </h4>

              <div
                style="color: black; margin-top: -100px; padding: 0px"
                class="d-flex justify-content-between text-center mt-3 mb-2"
              >
                <div style="position: relative; width: 50%; padding: 0px">
                  <p
                    class="mb-2 h5"
                    style="font-size: 18px; animation: fadeIn 5s"
                  >
                    De
                  </p>
              ...
              <div style="margin-left: -14px">
                ...
                <span>
                  ...
                  ><span style="color: black"
                    >Document(s): {{ quantityDocument }}</span
                  >
                </span>
                <!--    <span v-else>
              <p>No Documents</p>
              ...
              <div style="margin-left: -32px">
                ...
                <span>
                  <span style="color: black">
                    ...
                    >Ordinateur(s): {{ quantityComputer }}</span
                  >
                </span>
                <!--   <span v-else>
              <p>No Computer</p>
...
export default {
  data() {
    return {
      revPayId: localStorage.getItem("revPayId"),
  ...
  methods: {
    async createToken() {
      ...
      var config = {
        ...
        url:
          this.$url +
          `/payment/reservations?amount=${
            this.totalPrice * 100
          }&description=Reservation&token=${
            token.id
          }&reservationId=${localStorage.getItem(
            "revPayId"
          )}&currency=EUR&email=${localStorage.getItem("email")}`,
        headers: {
