    ...
    <div id="landing" class="sidebar-open">
        ...
        <div class="card card-hover" style="margin-left: 70px;margin-bottom:0px;">
            ...
            <div class="card-body" style="margin-top:90px;margin-left:50px">
                <h4 class="card-title text-primary fs-3">Tout les Articles</h4>
                                        ...
                                        <section id="contact" class="gray-bg padding-top-bottom">
                                            <div class="container bootstrap snippets bootdey">
                                                <div class="im" style="width:100%;display: flex;flex-wrap: wrap;">
                                                    <img v-for="(im,id) in path" v-bind:key="id" v-bind:src="urel+`/article/image?file=${im}`" style="height: 180px;width: 180px;margin: 5px;border: 2px solid #fff;"/>
                                                </div>
                                                <div class="row">
        ...
        style="font-size:28px;padding-bottom:10px; margin-top: 38px;"></i> </a>
                                  ...
                                  />
                                   ...
                                   <i class="fa fa-mobile" style="font-size:35px" v-else></i>
                                                        ...
                                                        <h5 style="display:flex;width:300px" class="modal-title" id="exampleModalLabel">Information du propriétaire
                                                        </h5>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <h6>Numero</h6><input v-model="phone" id="contact-name"
                                                                    name="contactName"
                                                                    class="form-control requiredField Highlighted-label"
                                                                    type="text" readonly>
...
export default {
    ...
    async created() {
        ...
        fetch(this.$url+"/articles", requestOptions0)
        ...
        view(item) {
            ...
            fetch(this.$url+"/article/paths/" + item.id, requestOptions5)
                ...
                .then(result => {
                    ...
                    console.log(this.$url+`/article/image?file=${this.path[0]}`);
                })
                .catch(error => console.log('error', error));
        },
        deleteArticles(id) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(this.$url+"/delete/article/" + id, requestOptions)
                        .then(response => response.text())
                        .then(result => {
                            console.log(result)
                            swalWithBootstrapButtons.fire(
