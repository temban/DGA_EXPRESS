                ...
                <div class="container d-flex justify-content-center mt-5">
                  <div class="card1">
                    ...
                    >
                      ...
                      <span
                        v-if="paymentMethod.length <=16"
                        style="font-weight: 700"
                        >{{ this.xafTotalPrice
                        }}<span style="color: blue">XAF</span></span
                      >
                      ...
                      <i
                        ...
                        style="font-size: 28px; color: blue; margin-left: 80px"
                      ></i>
...
export default {
  data() {
    return {
      ...
      login: false,
      cop: false,
      euroPercentagetotalPrice:
        JSON.parse(localStorage.getItem("sendPaymentProof")).quantity *
        JSON.parse(localStorage.getItem("sendPaymentProof")).article.price *
        (15 / 100),
      euroPrice:
        JSON.parse(localStorage.getItem("sendPaymentProof")).quantity *
        JSON.parse(localStorage.getItem("sendPaymentProof")).article.price,
      ...
      lastname: JSON.parse(localStorage.getItem("sendPaymentProof")).article
        .user.lastName,
      firstname: JSON.parse(localStorage.getItem("sendPaymentProof")).article
        .user.firstName,
      email: JSON.parse(localStorage.getItem("sendPaymentProof")).article.user
        .email,
      paymentMethod: JSON.parse(localStorage.getItem("sendPaymentProof"))
        .article.paymentMethod,
      profile: JSON.parse(localStorage.getItem("sendPaymentProof")).article.user
        .profileimgage,
      payProofFile: "",
      euroTotalPrice: "",
      xafTotalPrice: "",
  ...
  mounted() {
    ...
    $("body").on("change", "#fileInput", function (evt) {
      ...
      var name =
        JSON.parse(localStorage.getItem("sendPaymentProof")).article.user
          .lastName +
        "  " +
        JSON.parse(localStorage.getItem("sendPaymentProof")).article.user
          .firstName;
  ...
  methods: {
    ...
    sendProof() {
      ...
      let paid = () => {
        ...
        var config = {
          method: "get",
          url: this.$url + "/seller/paid?destinationId=" + this.destinationId,
          headers: {
