...
<div class="card1">
    ...
    <div  class="middle-container d-flex justify-content-between align-items-center mt-3 p-0">
        <div class="recent-border"> <span style="position:relative; margin-left:6px"> Method de Paiement: </span></div> 
         <i class="fa fa-credit-card" style="font-size:28px; color:blue;margin-left: 150px;" v-if="paymentMethod.length >15"></i>
          <i class="fa fa-mobile" style="font-size:32px;color:orangered; margin-left: 150px;" v-else></i><span class="recent-orders"> {{this.paymentMethod}}</span> 
...
export default{
    ...
    return {
        ...
        id: JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.userDto.id,
        lastname: JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.userDto.lastName,
        firstname:JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.userDto.firstName,
        email:JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.userDto.email,
        paymentMethod:JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.paymentMethod,
        profile:JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.userDto.profileimgage,
        departuretown:JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.departuretown,
        destinationtown:JSON.parse(localStorage.getItem("sendPaymentProof")).announcementDto.destinationtown,
        payProofFile:"", 
    }; 
  },
  components: {
...
var config = {
  method: 'get',
  url: 'https://dga-express.com:8443/traveller/paid?reservationId='+this.Revid,
  headers: { 
